---
title: "1. Prices, expectations, and market dynamics"
---
...
#| echo: false
#| warning: false
#| fig-cap: "QQQ (Nasdaq-100) and SPY (S&P 500) rebased to 100 in January 2021, alongside the 10-year TIPS real yield. The inverse relationship between rising real yields and long-duration equity prices is visible throughout 2022. Source: Yahoo Finance, FRED (DFII10)."
show("fig_2022_repricing.png")
```

## When a valid thesis becomes an unsustainable extrapolation

Speculative episodes are often treated as exceptions — departures from the normal condition of rational pricing that require special explanation. The historical record does not support that framing. Episodes of significant market excess have occurred across every major asset class, every institutional era, and in markets populated by professional investors as well as retail ones. What changes across episodes is the surface detail. The underlying structure is recognizable: a plausible initial thesis, rising prices that appear to validate it, broadening participation, weakening selectivity, and eventually a stage where price no longer needs strong fundamentals to keep moving [@kindleberger2011; @brunnermeier2016].

Speculative episodes rarely begin in nonsense. A genuine technological change, a structural decline in interest rates, a new regulatory opening — any of these can create a legitimate basis for early optimism. Barberis, Greenwood, Jin, and Shleifer make this point explicitly: good fundamental news can initiate a bubble rather than prevent one, because it attracts extrapolative capital that then continues well beyond what the original news can justify [@barberis2018]. The problem is what happens when a valid observation extends beyond what the evidence can support.
...
#| echo: false
#| warning: false
#| fig-cap: "Nasdaq Composite rebased to 100 in January 1995, alongside the S&P 500 Shiller CAPE. The Nasdaq rose approximately 400 percent by early 2000 while the CAPE reached historically extreme levels. The subsequent collapse brought both back toward starting points within two years. Source: Yahoo Finance, Shiller (2023)."
show2("fig_nasdaq_bubble.png")
```
...
The most consistent reason is relative-performance pressure. Underperforming a rising market inside investment organizations is experienced as active failure — visible to clients and to competitors. When a popular theme continues to work, the cost of staying outside it is not only financial. Careers, mandates, and client relationships are all affected by prolonged underperformance. Hong, Kubik, and Stein find that portfolio decisions are influenced by what peers are holding, in a way that amplifies rather than stabilizes price trends [@hong2005]. A second reason is that crowded trades can remain profitable well past the point where they appear analytically excessive — the mechanism sustaining them does not require fundamental support to remain operative in the short term. A third is that being early and being wrong are difficult to distinguish in real time, and reputational concerns create an incentive to act in line with others even when private signals diverge [@scharfstein1990].

When these episodes eventually reverse, the mechanism of the reversal matters as much as the magnitude. Some deflate slowly through earnings disappointment. Others break abruptly when financing conditions tighten or one large forced seller triggers a liquidity withdrawal. Brunnermeier and Schnabel show that when a boom was financed primarily through leverage, the damage from the bust tends to be substantially larger than when excess was driven by enthusiasm alone [@brunnermeier2016]. The chart below makes this contrast visible between the 2000–2002 Nasdaq bust and the 2007–2009 financial crisis — comparable peak-to-trough equity declines, but through fundamentally different mechanisms with very different systemic consequences.

```{python}
#| echo: false
#| warning: false
#| fig-cap: "Left: QQQ (Nasdaq-100) drawdown from peak, March 2000–October 2002. Right: XLF (S&P 500 Financials) drawdown from peak, October 2007–March 2009. Both produced severe equity drawdowns but through different mechanisms — an unlevered speculative collapse versus a leverage-amplified credit crisis. Source: Yahoo Finance."
show2("fig_bubble_drawdowns.png")
```

## The three questions a sound investment view must answer

These structural pressures — benchmark gravity, the profitability of crowded trades in the short term, and the difficulty of distinguishing early from wrong — make clear why sound investment work is so difficult to sustain even among skilled practitioners. The failure is rarely analytical incompetence. It is the absence of a complete thesis that holds up not just on the day the position is initiated but through the conditions that will test it.
...
#| echo: false
#| warning: false
#| fig-cap: "Shiller CAPE at start of period versus subsequent 10-year annualized real total return, S&P 500, 1881–2015. The negative slope confirms that higher starting valuations predict lower subsequent long-horizon returns. The wide dispersion confirms that CAPE is not a short-run timing signal. Source: Shiller (2023)."
...
#| echo: false
#| warning: false
#| fig-cap: "European Banks ETF (EUFN) versus S&P 500 (SPY), total return rebased to 100 in January 2011. Despite persistently low P/B ratios, European banks underperformed severely — apparent cheapness that was not a market error. Source: Yahoo Finance."
